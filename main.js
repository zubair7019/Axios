...
axios.get('https://jsonplaceholder.typicode.com/todos?_limit=5',{timout:5000})
 .then(res =>showOutput(res))
 .catch(err=>console.log(err))
...
function errorHandling() {
  ...
  ,{
    ...
    //   return status<500;//reject only if status is graeter or equal to 500
    // }
  })
 .then(res =>showOutput(res))
 .catch(err=>{
